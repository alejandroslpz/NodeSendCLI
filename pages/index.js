        ...
        {url ? (
          <>
            <p className="text-center text-2xl mt-10">
              <span className="font-bold text-red-700 text-3xl uppercase mr-2">
                Tu URL es:
              </span>
            ...
            <div className="lg:flex md:shadow-lg p-5 bg-white rounded-lg py-10">
              ...
              <div className="md:flex-1 mb-3 mx-2 mt-16 lg:mt-0">
                ...
                <p className="text-lg leading-loose">
                  ...
                  de que tus cosas no permanezcan en linea por siempre
                </p>
                <Link href="/crearcuenta">
                  <a className="text-red-500 font-bold text-lg hover:text-red-700">
                    Crea una cuenta para mayores beneficos
                  </a>
                </Link>
              </div>
            </div>
